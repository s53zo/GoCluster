...
type ClientOptions struct {
	...
	// InboundPublishQueueDepth bounds the inbound publish queue. When zero, publishes
	// are routed directly to the dispatcher (legacy unbuffered behavior).
	InboundPublishQueueDepth uint
	// InboundPublishWorkers controls the fixed worker pool size for inbound publish
	// dispatch when Order is false. Values <= 0 default to 1.
	InboundPublishWorkers int
	// InboundPublishEnqueueTimeout bounds how long QoS1/2 publishes may wait to
	// enqueue when the inbound queue is full. Zero disables the wait.
	InboundPublishEnqueueTimeout time.Duration
	ResumeSubs                   bool
...
func NewClientOptions() *ClientOptions {
	o := &ClientOptions{
		...
		InboundPublishQueueDepth:     0,
		InboundPublishWorkers:        0,
		InboundPublishEnqueueTimeout: 0,
		ResumeSubs:                   false,
...
// SetInboundPublishQueueDepth sets the bounded inbound publish queue depth.
// Use 0 to retain legacy unbuffered dispatch behavior.
func (o *ClientOptions) SetInboundPublishQueueDepth(depth uint) *ClientOptions {
	o.InboundPublishQueueDepth = depth
	return o
}

// SetInboundPublishWorkers sets the inbound publish dispatcher worker count.
// Values <= 0 default to 1.
func (o *ClientOptions) SetInboundPublishWorkers(workers int) *ClientOptions {
	o.InboundPublishWorkers = workers
	return o
}

// SetInboundPublishEnqueueTimeout bounds how long QoS1/2 publishes may wait to
// enqueue when the inbound queue is full. Zero disables the wait.
func (o *ClientOptions) SetInboundPublishEnqueueTimeout(timeout time.Duration) *ClientOptions {
	o.InboundPublishEnqueueTimeout = timeout
	return o
}
