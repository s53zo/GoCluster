...
func (r *ClientOptionsReader) InboundPublishQueueDepth() uint {
	s := r.options.InboundPublishQueueDepth
	return s
}

func (r *ClientOptionsReader) InboundPublishWorkers() int {
	s := r.options.InboundPublishWorkers
	return s
}

func (r *ClientOptionsReader) InboundPublishEnqueueTimeout() time.Duration {
	s := r.options.InboundPublishEnqueueTimeout
	return s
}
